    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('match_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='database.Match')),
            ],
        ),
        migrations.CreateModel(
            name='Player',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contract_start', models.DateField()),
                ('contract_end', models.DateField()),
                ('account_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='database.Player')),
            ],
        ),
        migrations.CreateModel(
            name='Position',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('offer_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='database.Offer')),
                ('player_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='database.Player')),
                ('president_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='database.President')),
            ],
        ),
        migrations.CreateModel(
            name='ProposeTrade',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stadium_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='database.Stadium')),
            ],
        ),
        migrations.CreateModel(
            name='Trade',
            fields=[
                ...
                ('deciding_president', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='database.President')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='trade_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='database.Trade'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='player_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='database.Player'),
        ),
        migrations.AddField(
            model_name='offer',
            name='deciding_president',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='database.President'),
        ),
        migrations.AddField(
            model_name='match',
            name='guest_team',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='guest_team', to='database.Team'),
        ),
        migrations.AddField(
            model_name='match',
            name='home_team',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='home_team', to='database.Team'),
        ),
        migrations.AddField(
            model_name='coach',
            name='team_name',
